...
export const SIGNATURE_DESTINATION_URL = 'https://liontechinnovations.co.uk/';
...
export const SIGNATURE_HTML = `<div style="font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.45;color:#263746;">
  ...
  <a href="https://liontechinnovations.co.uk/" target="_blank" rel="noopener noreferrer" style="display:block;width:600px;max-width:100%;margin-top:16px;text-decoration:none;">
