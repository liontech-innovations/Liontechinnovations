    ...
    case 'Anthropic':
      return (
        <svg viewBox="0 0 32 32" aria-hidden="true">
          <path d="M16 5 27 27h-5.2l-2.2-4.7h-7.2L10.2 27H5L16 5Zm-1.8 13.2h3.6L16 13.7l-1.8 4.5Z" />
        </svg>
      );
    case 'NVIDIA':
      return (
        <svg viewBox="0 0 32 32" aria-hidden="true">
          <path d="M4 10.3c6.7-2.9 13.8-3 21.5-.2-5.9.4-10.3 2.8-13.2 7.1 2.7-1.8 5.4-2.5 8.2-2.2 2.3.2 4.6 1.1 7.1 2.6-3.2 3.2-6.8 4.8-10.7 4.7-4.8-.1-8.8-2.5-12-7.2 3.5.6 6.4.2 8.9-1.2-3.2-.9-6.4-.8-9.8.3v-3.9Zm13.8 6.3a2.6 2.6 0 1 0 0 5.2 2.6 2.6 0 0 0 0-5.2Z" />
        </svg>
      );
    case 'Vercel':
      return (
        <svg viewBox="0 0 32 32" aria-hidden="true">
          <path d="M16 6 30 27H2L16 6Z" />
        </svg>
      );
    case 'AWS':
      return (
        <svg viewBox="0 0 42 32" aria-hidden="true">
          <path d="M7.8 9.5 3.4 22.6h3.4l.8-2.8h4.4l.8 2.8h3.5L11.8 9.5h-4Zm.6 7.6 1.4-4.6 1.4 4.6H8.4Zm12.8 5.5-2.9-8.2h3.1l1.2 4.3 1.4-4.3h2.6l1.4 4.3 1.2-4.3h3l-2.9 8.2h-2.7l-1.4-4.1-1.4 4.1h-2.6Z" />
          <path d="M10 26c7 3.2 14.2 3.1 21.7-.4.8-.4 1.5.7.7 1.3-6.2 4.6-15.3 4.9-23.1.8-.9-.5-.2-2.1.7-1.7Z" />
          <path d="M30.6 24.2c1.8-.2 4.1.1 4.6.7.5.7-.5 2.9-1.8 4.2-.4.4-.9.2-.7-.4.4-1 .8-2 .5-2.4-.3-.3-1.4-.4-2.5-.3-.7.1-.8-1.6-.1-1.8Z" />
        </svg>
      );
    case 'Supabase':
      return (
        <svg viewBox="0 0 32 32" aria-hidden="true">
          <path d="M17.1 2.8 5 18.1c-.9 1.2-.1 2.9 1.4 2.9h8.1l-1.6 8.1c-.3 1.5 1.6 2.4 2.5 1.1L27 14.6c.9-1.2.1-2.8-1.4-2.8h-8l1.1-7.9c.2-1.4-1.7-2.3-2.6-1.1Z" />
        </svg>
      );
    case 'Stripe':
      return (
        <svg viewBox="0 0 44 32" aria-hidden="true">
          <path d="M5 21.5v-4.1c2 1.1 4.3 1.7 6.2 1.7 1.3 0 2.1-.3 2.1-1.1 0-2.3-8.2-1.4-8.2-7 0-3.3 2.7-5.3 7.1-5.3 1.8 0 3.6.3 5.4 1v4c-1.7-.9-3.8-1.4-5.5-1.4-1.2 0-1.9.3-1.9 1 0 2.2 8.2 1.1 8.2 7 0 3.4-2.8 5.4-7.4 5.4-2.2 0-4.4-.4-6-1.2Zm16.5-14.9h4.9v15.7h-4.9V6.6Zm7.5 0h4.6l.2 1.5c1-1.2 2.5-1.8 4.1-1.8v4.6c-1.8-.1-3.2.3-4 1.1v10.3H29V6.6Z" />
        </svg>
      );
    case 'OpenAI':
      return (
        <svg viewBox="0 0 32 32" aria-hidden="true">
          <path d="M15.9 2.8a5.8 5.8 0 0 1 5.2 3.2 6 6 0 0 1 6.7 8.5 5.9 5.9 0 0 1-3.7 9.4 5.8 5.8 0 0 1-9.4 4.2 6 6 0 0 1-8.6-6.6 5.9 5.9 0 0 1 .5-10.2 5.9 5.9 0 0 1 9.3-8.5Zm3.2 5.4-7.2 4.1v8.2l2.4 1.4v-8.1l7.2-4.1-2.4-1.5Zm-5.8 16.3a3.6 3.6 0 0 0 5.9-2.7l-7.1-4.1-2.4 1.4 7 4.1-3.4 1.3Zm9-4a3.7 3.7 0 0 0 2.5-6.1l-7 4.1v2.8l7-4.1-2.5 3.3Zm1.1-9.3a3.6 3.6 0 0 0-6-2.7l.1 8.2 2.4-1.4-.1-8 3.6 3.9ZM8.6 13.8a3.6 3.6 0 0 0-1 6.4l7.1-4.1v-2.8l-7 4.1.9-3.6Zm3.9-7.3a3.6 3.6 0 0 0-4.2 5.5l7.1-4.1 2.4 1.4-7 4.1 1.7-6.9Z" />
        </svg>
      );
    case 'Microsoft Azure':
      return (
        <svg viewBox="0 0 36 32" aria-hidden="true">
          <path d="M15.2 3.2 5 25.7h8.9l13.6-22.5H15.2Zm3.6 12.7-5 9.8h16.1L18.8 15.9Z" />
        </svg>
      );
    case 'Google Cloud':
      return (
        <svg viewBox="0 0 42 32" aria-hidden="true">
          <path d="M27.9 12.2a8.8 8.8 0 0 0-16.4-2.4 7.4 7.4 0 0 0 .7 14.8h15a6.3 6.3 0 0 0 .7-12.4Zm-16 8.2a3.3 3.3 0 0 1 .3-6.6h1.7l.5-1.6a5.6 5.6 0 0 1 10.7 1.6v1.7h1.9a3.2 3.2 0 1 1 0 6.4H11.9Z" />
        </svg>
      );
    case 'GitHub':
      return (
        <svg viewBox="0 0 32 32" aria-hidden="true">
          <path d="M16 3.4a12.8 12.8 0 0 0-4 25c.6.1.8-.2.8-.6v-2.2c-3.3.7-4-1.4-4-1.4-.5-1.3-1.3-1.7-1.3-1.7-1.1-.7.1-.7.1-.7 1.2.1 1.8 1.2 1.8 1.2 1 .1.7 2.6 3.3 1.9.1-.8.4-1.3.7-1.6-2.6-.3-5.4-1.3-5.4-5.7 0-1.3.5-2.3 1.2-3.1-.1-.3-.5-1.6.1-3.2 0 0 1-.3 3.2 1.2a11 11 0 0 1 5.8 0c2.2-1.5 3.2-1.2 3.2-1.2.6 1.6.2 2.9.1 3.2.8.8 1.2 1.8 1.2 3.1 0 4.4-2.8 5.4-5.4 5.7.4.4.8 1.1.8 2.2v3.3c0 .4.2.7.8.6a12.8 12.8 0 0 0-4-25Z" />
        </svg>
      );
    default:
      return null;
  ...
  return (
    <nav
      className={`fixed left-0 top-0 z-50 w-full transition-all duration-300 ${
        isScrolled
          ? 'border-b border-[#C8A24A]/14 bg-[#020817]/90 py-2.5 shadow-[0_14px_44px_rgba(0,0,0,0.28)] backdrop-blur-xl'
          : 'border-b border-white/8 bg-[#020817]/30 py-3.5 backdrop-blur-[3px]'
      }`}
    >
      <div className="relative mx-auto flex max-w-[1320px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <a
          href="#/"
          className="flex min-w-0 max-w-[calc(100%-3.5rem)] items-center no-underline"
          onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
        >
          <img src="/assets/liontechlogo-web.png" alt="LionTech Innovations" className="nav-logo" />
        </a>
        ...
        <div className="hidden items-center gap-7 lg:flex">
          {navLinks.map((link) => (
            <button
              ...
              className="border-none bg-transparent text-[11px] font-bold uppercase tracking-[0.22em] text-white/74 transition hover:text-[#C8A24A]"
            >
              {link.label}
            </button>
          ))}
          <button
            ...
            className="btn-primary rounded-md px-6 py-2.5 text-[11px] uppercase tracking-[0.16em]"
          >
            Get Started
          </button>
        </div>
          ...
          <div className="mx-auto max-w-[1320px] space-y-1.5">
            {navLinks.map((link) => (
              <button
                key={link.id}
                onClick={() => handleNav(link.id)}
                className="block w-full rounded-md border-none bg-transparent px-3 py-2.5 text-left text-[12px] font-bold uppercase tracking-[0.18em] text-white/78 transition hover:bg-white/8 hover:text-[#C8A24A]"
              >
                {link.label}
              </button>
            ))}
            <button
              onClick={() => handleNav('contact')}
              className="btn-primary mt-2 w-full rounded-md px-6 py-3 text-[11px] uppercase tracking-[0.16em]"
            >
              Get Started
            </button>
          </div>
...
const TrustStrip = () => (
  <div className="trust-strip hero-trust mx-auto w-full min-w-0 max-w-[1320px] overflow-hidden rounded-md border border-[#C8A24A]/14 bg-[#020817]/76 px-3 py-2.5 shadow-[0_14px_48px_rgba(0,0,0,0.28)] backdrop-blur-xl sm:px-4">
    <div className="flex min-w-0 items-center gap-3 overflow-x-auto [scrollbar-width:none] md:gap-3.5 [&::-webkit-scrollbar]:hidden">
      <div className="shrink-0 border-r border-[#C8A24A]/18 pr-4 text-[8px] font-bold uppercase leading-snug tracking-[0.16em] text-white/48 sm:text-[9px]">
        Trusted by
        <br />
        modern businesses
      </div>
  ...
  <section className="relative isolate min-h-[600px] overflow-hidden bg-[#071426] pt-20 text-white lg:pt-24">
    ...
    <div className="relative z-10 mx-auto flex min-h-[510px] w-full min-w-0 max-w-[1320px] flex-col justify-center px-4 pb-6 sm:px-6 lg:px-8">
      <div className="hero-copy w-full max-w-[620px] pt-5 sm:pt-7">
        <span className="inline-flex max-w-full items-center rounded-md border border-[#C8A24A]/24 bg-[#020817]/34 px-3.5 py-1.5 text-[8px] font-bold uppercase leading-5 tracking-[0.16em] text-white/82 shadow-[0_10px_30px_rgba(0,0,0,0.18)] backdrop-blur-md sm:text-[9px] sm:tracking-[0.28em]">
        ...
        <h1 className="mt-5 text-[34px] font-black leading-[1.06] tracking-[-0.018em] text-white sm:text-[46px] md:text-[54px] lg:text-[60px]">
          ...
          <span className="block text-gradient-gold">Scalable Platforms.</span>
        </h1>

        <p className="mt-5 max-w-[330px] text-[15px] font-medium leading-7 text-white/82 sm:max-w-xl sm:text-base">
          LionTech Innovations builds production-ready AI systems, automation workflows, and SaaS platforms for businesses that need reliable digital infrastructure.
        </p>

        <div className="mt-7 flex flex-col gap-3 sm:flex-row">
          <button
            onClick={() => scrollToSection('contact')}
            className="btn-primary w-full rounded-md px-6 py-3 text-[11px] uppercase tracking-[0.16em] sm:w-auto sm:min-w-[210px]"
          >
            Book a Consultation
            <ArrowRight size={15} />
          </button>
          <button
            ...
            className="btn-secondary-dark w-full rounded-md px-6 py-3 text-[11px] uppercase tracking-[0.16em] sm:w-auto sm:min-w-[155px]"
          >
            View Services
          </button>
        </div>
...
const Stats = () => {
  ...
  return (
    <section className="border-y border-[#C8A24A]/10 bg-[#020817]">
      <div className="mx-auto grid max-w-[1320px] grid-cols-1 divide-y divide-white/8 px-4 py-5 sm:px-6 md:grid-cols-2 md:divide-x md:divide-y-0 lg:grid-cols-4 lg:px-8">
        {stats.map((item) => (
          <div key={item.label} className="flex gap-4 py-5 md:px-5 lg:px-6">
            ...
            <div>
              <p className="text-3xl font-black leading-none tracking-[-0.035em] text-white">{item.value}</p>
              <p className="mt-1.5 text-[10px] font-bold uppercase tracking-[0.22em] text-white/74">{item.label}</p>
              <p className="mt-2 max-w-[210px] text-[13px] leading-5 text-white/56">{item.copy}</p>
            </div>
          </div>
        ))}
      </div>
...
const Platforms = () => {
  ...
  return (
    <section id="platforms" className="bg-[#071426] py-14 text-white sm:py-18">
      <div className="mx-auto grid max-w-[1320px] gap-8 px-4 sm:px-6 lg:grid-cols-[0.68fr_1.32fr] lg:px-8">
        <div>
          <span className="section-eyebrow text-[#C8A24A]">Our Live Platforms</span>
          <h2 className="mt-3 max-w-md text-3xl font-black tracking-[-0.04em] text-white sm:text-[34px]">
            Real Systems. Real Impact.
          </h2>
          <p className="mt-4 max-w-md text-[15px] leading-6 text-white/62">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          {projects.map((project) => (
            <a
              ...
              className="dark-card group flex min-h-[220px] flex-col p-5 no-underline"
            >
              <div className="mb-4 flex items-center justify-between gap-2">
                <div className="flex items-center gap-2.5">
                  <span className="flex h-9 w-9 items-center justify-center rounded-md border border-[#C8A24A]/16 bg-white/5 text-[#C8A24A]">
                    {project.icon}
                  </span>
                  <span className="rounded-full bg-[#C8A24A]/10 px-2.5 py-1 text-[9px] font-bold uppercase tracking-[0.14em] text-[#D8BE74]">
                    {project.category}
                  </span>
                </div>
              ...
              <span className="mt-5 inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.15em] text-[#C8A24A] transition group-hover:text-white">
                Visit Platform
...
const Services = () => {
  ...
  return (
    <section id="services" className="bg-[#F4F7FB] py-16 sm:py-20">
      <div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <span className="section-eyebrow text-[#A77F26]">Our Capabilities</span>
          <h2 className="mt-3 text-3xl font-black tracking-[-0.045em] text-[#071426] sm:text-[40px]">
            Enterprise-Grade Solutions
          </h2>
          <p className="mt-4 text-base leading-7 text-[#455A6E]">
        ...
        <div className="mt-9 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div key={service.title} className="light-card group p-5">
              <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-md bg-[#F3EAD1] text-[#A77F26] transition group-hover:bg-[#071426] group-hover:text-[#C8A24A]">
                {service.icon}
              </div>
  ...
  return (
    <section id="company" className="bg-white py-16 sm:py-20">
      <div className="mx-auto grid max-w-[1320px] grid-cols-1 items-center gap-9 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div>
          <span className="section-eyebrow text-[#A77F26]">Company</span>
          <h2 className="mt-3 max-w-2xl text-3xl font-black tracking-[-0.045em] text-[#071426] sm:text-[40px]">
            Engineered for Serious Business
          </h2>
          <p className="mt-4 max-w-2xl text-base leading-7 text-[#455A6E]">
        ...
        <div className="grid gap-3.5 sm:grid-cols-2">
          {highlights.map((item) => (
            <div key={item} className="flex items-start gap-3 rounded-md border border-[#E2D3A6] bg-[#FBFAF6] p-4">
              <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#F3EAD1] text-[#A77F26]">
                <CheckCircle2 size={14} />
              </span>
              <p className="text-[14px] font-semibold leading-6 text-[#071426]">{item}</p>
            </div>
          ))}
        </div>
      </div>
...
const Contact = () => (
  <section id="contact" className="relative overflow-hidden bg-[#020817] py-16 text-white sm:py-20">
    ...
    <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
      ...
      <h2 className="mt-3 text-3xl font-black tracking-[-0.045em] text-white sm:text-[40px]">
      ...
      <div className="mx-auto mt-9 grid max-w-3xl grid-cols-1 gap-4 sm:grid-cols-2">
        <a href="mailto:contact@liontechinnovations.co.uk" className="dark-card p-5 text-left no-underline">
          <Mail className="mb-4 text-[#C8A24A]" size={22} />
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/44">Email</p>
          <p className="mt-2 break-words text-[15px] font-semibold text-white">contact@liontechinnovations.co.uk</p>
        </a>
        <div className="dark-card p-5 text-left">
          <MapPin className="mb-4 text-[#C8A24A]" size={22} />
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-white/44">Location</p>
          <p className="mt-2 text-[15px] font-semibold text-white">London, United Kingdom</p>
        </div>
      </div>

      <a
        href="mailto:contact@liontechinnovations.co.uk"
        className="btn-primary mt-8 rounded-md px-7 py-3 text-[11px] uppercase tracking-[0.16em] no-underline"
      >
        Book a Consultation
        <ArrowRight size={15} />
      </a>
    ...
    <div className="mx-auto grid max-w-[1320px] grid-cols-1 gap-7 px-4 sm:px-6 md:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] lg:px-8">
      <div>
        <a href="#/" className="flex items-center no-underline">
          <img src="/assets/liontechlogo-web.png" alt="LionTech Innovations" className="footer-logo" />
        </a>
        <p className="mt-3 max-w-xs text-[13px] leading-6 text-[#455A6E]">
