...
export function ContactPage() {
  ...
  return (
    <>
      <PageHero eyebrow="REQUEST A FOUNDING SNAPSHOT" title="Tell us which business AI should understand." description="A short enquiry first. Full onboarding only begins after the Snapshot scope is agreed." />
      <RouteSection className="lt-route-contact-section" id="snapshot-enquiry">
        <div className="lt-route-contact-layout">
          <div className="lt-route-contact-aside">
