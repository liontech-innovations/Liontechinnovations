# AI Search Entity Authority Plan

Owner: Founder / Lion Tech Innovations Ltd

Status: handoff only — no accounts or profiles were created by this change

Entity reviewed: 2026-08-15

## Canonical entity facts

- Legal name: Lion Tech Innovations Ltd
- Company number: 17068390
...
7. Seek earned references through useful research, real partnerships, public talks and documented client outcomes. Publish case studies only with permission and evidence.
8. Record each external profile in an entity ledger with owner, URL, last review date and correction status.

## Prohibited tactics

- Purchased spam links, reciprocal-link schemes or automated directory blasts.
- Fake reviews, fake awards, invented accreditations or unverifiable statistics.
- Fabricated case studies, partnerships, office locations or founder credentials.
- Claims that a profile guarantees AI citation, search visibility or recommendation.
